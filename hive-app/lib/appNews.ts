...
export const APP_NEWS: AppNewsEntry[] = [
  ...
  },
  {
    ...
    detail: 'Join Google Meet lives on the upcoming meeting card now, times read like 6pm instead of 18:00:00, editing a meeting shows the Meet link it carries, and finishing a check-in never locks you out of opening it again.',
    href: { pathname: '/meetings' },
    action: 'Open Meetings',
  },
  {
  ...
  },
  {
    ...
    detail: 'It used to live only at HIVE-Wide. It is in every HIVE\'s list now, showing the identical archive, so you never have to go up a level to read the newsletter. Shout-outs for the next one come straight from your End of the month check-in — there is no thread to go and find.',
    href: { pathname: '/buzz' },
  ...
  },
  {
    ...
    detail: 'A new question in the Before we meet check-in — it shows on your profile.',
    href: { pathname: '/monthly-tuneup' },
  ...
  },
  {
    ...
    date: '2026-07-08',
    title: 'The check-in became a guided walk-through',
  ...
  },
  {
    ...
    date: '2026-06-10',
    title: 'There is a check-in before every meeting',
