...
export const DAILY_QUESTIONS: DailyQuestion[] = [
  ...
  { text: 'What everyday luxury makes you feel instantly richer?', category: 'daily joy', emoji: '✨', themes: ['comfort', 'play'] },
  ...
  { text: 'What is one thing you would put in a museum of your life?', category: 'life museum', emoji: '🏛️', themes: ['memory', 'identity'] },
  ...
  { text: 'What is a skill you learned the hard way?', category: 'earned wisdom', emoji: '🧵', themes: ['learning', 'growth'] },
  ...
  { text: 'Would you rather be great at remembering names, birthdays, or every detail?', category: 'attention', emoji: '🔎', themes: ['connection', 'generosity'] },
  ...
  { text: 'What is a ceremony you could add to endings?', category: 'closure ritual', emoji: '🕯️', themes: ['ritual', 'growth'] },
  ...
  { text: 'If HIVE took a field trip, where should we go?', category: 'field trip', emoji: '🚌', themes: ['community', 'place'] },
  ...
  { text: 'What is a project that would be more fun with the right team?', category: 'project partners', emoji: '🤝', themes: ['community', 'work'] },
  ...
  { text: 'What public service announcement do you stand by?', category: 'psa', emoji: '📣', themes: ['values', 'humour'] },
  ...
  { text: 'What dare would you accept this month?', category: 'monthly dare', emoji: '🎯', themes: ['courage', 'play'] },
  ...
  { text: 'What ordinary moment do you wish you could replay?', category: 'ordinary magic', emoji: '🔁', themes: ['memory', 'comfort'] },
  ...
  { text: 'What object would you rescue first in a move?', category: 'keepsakes', emoji: '📦', themes: ['home', 'memory'] },
  ...
  { text: 'What purchase improved your life?', category: 'small upgrade', emoji: '🛍️', themes: ['comfort', 'home'] },
  ...
  { text: 'What detail do you remember from an important day?', category: 'detail memory', emoji: '🔎', themes: ['memory', 'ritual'] },
  ...
  { text: 'What landmark belongs on your personal map?', category: 'personal landmark', emoji: '🗺️', themes: ['place', 'memory'] },
  ...
  { text: 'What accountability structure would actually help you?', category: 'accountability', emoji: '✅', themes: ['growth', 'community'] },
  ...
  { text: 'What community ritual would make HIVE feel warmer?', category: 'warm rituals', emoji: '🔥', themes: ['community', 'ritual'] },
  ...
  { text: 'What act of hospitality do you admire?', category: 'hospitality', emoji: '☕', themes: ['generosity', 'home'] },
  ...
  { text: 'What experiment could you run this week?', category: 'weekly experiment', emoji: '🧪', themes: ['learning', 'work'] },
  ...
  { text: 'What proof tells you your plan is working?', category: 'proof of life', emoji: '📈', themes: ['work', 'growth'] },
  ...
  { text: 'What business idea makes you smile?', category: 'business spark', emoji: '💡', themes: ['ambition', 'play'] },
  ...
  { text: 'What promise can you keep by Friday?', category: 'friday promise', emoji: '📝', themes: ['work', 'growth'] },
  ...
  { text: 'What rebellion improved your life?', category: 'everyday rebellion', emoji: '⚡', themes: ['boundaries', 'courage'] },
  ...
  { text: 'Would you rather have a robot, a talking mirror, or a loyal umbrella?', category: 'magic objects', emoji: '🪞', themes: ['play', 'humour'] },
  ...
  { text: 'What inconvenience would you outlaw?', category: 'outlaw this', emoji: '🚫', themes: ['humour', 'boundaries'] },
  { text: 'What inconvenience do you weirdly tolerate?', category: 'tolerated nuisance', emoji: '🤷', themes: ['humour', 'identity'] },
  ...
  { text: 'What daily nuisance needs a ceremonial goodbye?', category: 'goodbye nuisance', emoji: '👋', themes: ['ritual', 'humour'] },
