...
Validation: typecheck and web export; check-in suites and new wish-action/vote fixtures cover retired-note preservation, owner/source scope, archive failure, vote denominators and updates. The first live Archive-menu check unexpectedly executed through a native browser confirmation. The exact affected wish was restored, including its existing HIVE-Wide visibility and meeting focus. Archive and Delete now use HIVE's in-app ConfirmDialog; cancellation fixtures verify that the selection remains. The private Brain receipt records restoration and live verification. No survey submission, emails or approval changes were made.
