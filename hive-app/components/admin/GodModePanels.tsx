...
export function HiveMemberPanels({
   ...
   */
  const seasonFillHive = memberships
    .find((m) => m.community_id === seasonFill?.communityId)?.community;
  const seasonFillAccent = hiveAccent(seasonFillHive);
