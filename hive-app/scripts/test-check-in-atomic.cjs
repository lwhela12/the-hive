...
(async () => {
 const db = new PGlite();
 const u='00000000-0000-0000-0000-000000000001', h='00000000-0000-0000-0000-000000000002', other='00000000-0000-0000-0000-000000000003', s='00000000-0000-0000-0000-000000000004', e='00000000-0000-0000-0000-000000000005', monthSurvey='00000000-0000-0000-0000-000000000006';
 ...
 insert into profiles values ('${u}'); insert into communities values ('${h}'),('${other}');
 insert into surveys values ('${s}','premeeting',true,null),('${monthSurvey}','endofmonth',true,null);
 insert into community_memberships values ('${u}','${h}');
 ...
 assert.equal((await db.query('select count(*)::int as n from check_in_completions')).rows[0].n,3);
 ...
 const meetingAnswers=(await db.query("select occurrence,answers from check_in_completions where survey_id=$1 order by occurrence",[s])).rows;
