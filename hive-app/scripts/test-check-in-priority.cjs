...
vm.runInNewContext(ts.transpileModule(fs.readFileSync('lib/dateUtils.ts', 'utf8'), { compilerOptions: { module: ts.ModuleKind.CommonJS } }).outputText, { exports: dateModule.exports, module: dateModule, Date });
const moduleObject = { exports: {} };
vm.runInNewContext(ts.transpileModule(fs.readFileSync('lib/checkInPresentation.ts', 'utf8'), { compilerOptions: { module: ts.ModuleKind.CommonJS } }).outputText, { exports: moduleObject.exports, module: moduleObject, Date, Set, require: id => id === './dateUtils' ? dateModule.exports : require(id) });
...
assert.equal(moduleObject.exports.meetingLabel({event_date:'2026-09-08',event_time:'18:00:00'}, '2026-09-05'), 'Tue, Sept 8 · 6pm PT');
